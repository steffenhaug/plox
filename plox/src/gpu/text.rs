...
use crate::font;
use crate::gpu::{
    shader::{Shader, UniformMat4, UniformMultiSampler2D, UniformVec2, UniformVec2i},
    Render, Vao, Vbo,
};
...
pub struct TextRenderer {
    ...
    u_sampler: UniformMultiSampler2D,
...
impl Render for TextRenderer {
    ...
    unsafe fn invoke(&self, state: &Self::State) {
        ...
        gl::Uniform2i(self.u_tex_dims.0, w as i32, h as i32);
...
impl TextRenderer {
    pub unsafe fn new() -> Self {
        ...
        let u_sampler = sample.uniform_sampler2d("tex");
